...
# Skip public sample if it contains NaN
        ...
        try:
            ...
            print("Registered landmarks len:", len(reg_features[0]))
            print("Public landmarks len:", len(face_encoding))
            print("Registered sample:", reg_features[0][:10])
            print("Public sample:", face_encoding[:10])
